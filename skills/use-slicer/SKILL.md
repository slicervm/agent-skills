---
name: use-slicer
description: Use Slicer to launch Linux microVMs for sandboxed builds, E2E tests, Docker, CI, port forwarding, agent sandboxes, and isolated dev environments on macOS or Linux hosts.
license: MIT
